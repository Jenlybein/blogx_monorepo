...
`,[z(">",[s("clear",`
 ...
 `,[vn({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),ye=$({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(t){return Re("-base-clear",wo,ge(t,"clsPrefix")),{handleMouseDown(l){l.preventDefault()}}},render(){const{clsPrefix:t}=this;return a("div",{class:`${t}-base-clear`},a(mn,null,{default:()=>{var l,r;return this.show?a("div",{key:"dismiss",class:`${t}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},G(this.$slots.icon,()=>[a(ae,{clsPrefix:t},{default:()=>a(go,null)})])):a("div",{key:"icon",class:`${t}-base-clear__placeholder`},(r=(l=this.$slots).placeholder)===null||r===void 0?void 0:r.call(l))}}))}}),xo=$({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(t,{slots:l}){return()=>{const{clsPrefix:r}=t;return a(pn,{clsPrefix:r,class:`${r}-base-suffix`,strokeWidth:24,scale:.85,show:t.loading},{default:()=>t.showArrow?a(ye,{clsPrefix:r,show:t.showClear,onClear:t.onClear},{placeholder:()=>a(ae,{clsPrefix:r,class:`${r}-base-suffix__arrow`},{default:()=>G(l.default,()=>[a(po,null)])})}):null})}}}),De=gn("n-input"),Co=x("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
...
`,[s("input, textarea",`
 ...
 `),z("&:-webkit-autofill ~",[s("placeholder","display: none;")])]),T("round",[K("textarea","border-radius: calc(var(--n-height) / 2);")]),s("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),T("textarea",[s("placeholder","overflow: visible;")]),K("autosize","width: 100%;"),T("autosize",[s("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `),["warning","error"].map(t=>T(`${t}-status`,[K("disabled",[x("base-loading",`
